...
class signin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signinbtn.setOnClickListener {
            ...
            if (uname.isNotEmpty() && password.isNotEmpty() && !uname.isNullOrBlank() && !password.isNullOrBlank() && uname.length >= 8 && uname.length <= 11 && password.length >= 8) {

                readData(uname, password)


            } else {
//                Toast.makeText(this, "please enter all details \n \"Make sure that the username consist max 11 characters and password must contain at least  8 characters", Toast.LENGTH_SHORT).show()
                val one =
                    Snackbar.make(main_id, "username 8-11 char.. \nPassword should consist of least 8 char..", Snackbar.LENGTH_SHORT)
...
//                    Toast.makeText(this, "Hurry!", Toast.LENGTH_SHORT).show()
                    ...
                    editor.putString("unamepref", uname)
